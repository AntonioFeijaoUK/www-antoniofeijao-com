...
Anyone knows how to get the list without using the error?
...
Just a curiosity... I `echo` all the services names to `wc -l` to get a count.

See for yourselfe how many boto3.client AWS has, it should give us an idea of how many services AWS has.
